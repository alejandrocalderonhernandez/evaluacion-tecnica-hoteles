...
public class CacheBeans {
    ...
    public CacheManager cacheManager(RedissonClient redissonClient) {
        var configs = Map.of(
                CacheConstants.BOOKING_CACHE_NAME, new CacheConfig(),
                CacheConstants.CUSTOMER_CACHE_NAME, new CacheConfig(),
                CacheConstants.ROOMS_CACHE_NAME, new CacheConfig()
        );
    ...
    @CacheEvict(cacheNames ={
            ...
            CacheConstants.ROOMS_CACHE_NAME
    }, allEntries = true)
